...
<table class="table table-hover  my-3" id="myTable"style="background:white;border:0;padding:10px;">
  <thead>
  <tr>
  <th colspan="7" class="text-center "> <h2 style="color:black;">STUDENTS<button class="btn btn-dark" type="button" data-toggle="modal" data-target="#addmodal" id="btn">Add Students</button></h2></th>
  </tr>
    <tr class="bg-danger">
      <th scope="col" class="text-center " style="color:white;" >S.no</th>
      <th scope="col" class="text-center "style="color:white;" >NAME</th>
      <th scope="col" class="text-center "style="color:white;" >ENROLLMENT NO</th>
...
foreach($result as $row) { 
      ?>
       ...
       <td class="text-center "><?php echo $row['Enrolno'];?></td>
       ...
       <td class="text-center "> <button type="button" class="btn btn-info editbtn"data-toggle="modal" data-target="#studentmodal" ><i class="fa fa-pencil" aria-hidden="true" id="edit" ></i></button>
